...
set_target_properties(Qt6::Mqtt PROPERTIES
  ...
  INTERFACE_SOURCES "\$<\$<BOOL:\$<TARGET_PROPERTY:QT_CONSUMES_METATYPES>>:${_IMPORT_PREFIX}/./metatypes/qt6mqtt_debug_metatypes.json>"
...
set_target_properties(Qt6::MqttPrivate PROPERTIES
  ...
  # D:/TOOLS/projects/QtProjects/build-qtmqtt-Qt_6_7_0_Clang_arm64_v8a-Debug/src/mqtt;
...
set_target_properties(Qt6::Mqtt PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libQt6Mqtt_arm64-v8a.so"
  IMPORTED_SONAME_DEBUG "libQt6Mqtt_arm64-v8a.so"
  )
